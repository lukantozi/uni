...
#print(merge_two_sorted_lists(MERGE_CASES[2][0], MERGE_CASES[2][1]))
...
#print(binary_search(BINARY_SEARCH_CASES[2][0], BINARY_SEARCH_CASES[2][1]))
#print(binary_search(BINARY_SEARCH_CASES[3][0], BINARY_SEARCH_CASES[3][1]))
...
def quick_sort_inplace(nums, low=0, high=None):
    ...
    def _qsortin(arr, low, high):
        if high > low:
            pi = partition(arr, low, high)
            _qsortin(arr, low, pi - 1)
            _qsortin(arr, pi + 1, high)
